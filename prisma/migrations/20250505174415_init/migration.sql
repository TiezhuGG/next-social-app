...
-- CreateIndex
CREATE UNIQUE INDEX "FollowerRequest_senderId_receiverId_key" ON "FollowerRequest"("senderId", "receiverId");
...
-- AddForeignKey
ALTER TABLE "FollowerRequest" ADD CONSTRAINT "FollowerRequest_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
